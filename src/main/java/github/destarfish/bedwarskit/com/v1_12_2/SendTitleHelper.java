...
public final class SendTitleHelper {
    public static void sendTitle(Player player, String title, String subtitle, int fadeInTime, int stayTime, int fadeOutTime) {
        if (title != null) {
            io.github.bedwarsrel.com.v1_12_r1.Title.showTitle(player, title, fadeInTime, stayTime, fadeOutTime);
        }     if (subtitle != null) {

        io.github.bedwarsrel.com.v1_12_r1.Title.showSubTitle(player, subtitle, fadeInTime, stayTime, fadeOutTime);
    }
    }
